...
<head>
    ...
    <title>เพิ่มข้อมูลอินโฟกราฟิก</title>
     ...
     <section style="margin-bottom: 400px;background:transparent;;position: relative;display: flex;justify-content: center;align-items: center;">
          <div class="row" style="margin-top: 10px;display: flex;justify-content: center;align-items: center;width: 88.5%;">
            <div class="col-12">
                ...
                <div style="width: 100%;" >
                        <h4 style="float: left;">ข้อมูลอินโฟกราฟิก</h4>
                        <h4 style="float: right;">
                        <button class="btn btn-primary"   data-bs-toggle="modal" data-bs-target="#multimidiaModal">เพิ่มข้อมูลอินโฟกราฟิก</button>
                        </h4>
                    </div>
                </div>
                <br>
                <div class="container mt-4">
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                                <?php
                                include "connect.php";
                                $query = "SELECT * FROM `infographicinfo`"; // Adjust the query to match your table structure            
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<tr class='text-white'>
                                                ...
                                                <td class='text-center'>
                                                    <a href='delete-infographic.php?id={$mul_id}'><button class='btn btn-danger'>ลบ</button></a>
                                                </td>
                                            </tr>";
                                    }
                                } else {
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div style="width: 100%;" class="card">
                        ...
                        <div class="container mt-4">
                            <div style="width: 100%;" >
                                <h4 style="float: left;">เพิ่มข้อมูลอินโฟกราฟิก</h4>    
                            </div>
                        </div>
                        </div>
                        <br>
    ...
    <script>
        $(document).ready(function() {
            $('#infographicForm').on('submit', function(event) {
                ...
                $.ajax({
                    url: 'act-add-infographic.php',  // Replace with your PHP file to handle the request
                    type: 'POST',
                    data: formData,
                    ...
                    success: function(response) {
                        if (response == 'true') {
                            ...
                            setTimeout(function() {
                                window.location.href = 'add-infographic.php';  // Redirect to your desired page
                            }, 1000);
                        } else {
