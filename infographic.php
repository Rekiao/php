...
<body style="background-image: url('imanges/18544.jpg');background-position: center;background-size: cover;background-repeat: no-repeat;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <select name="subject" id="subject" class="form-control" style="border-radius: 20px;border: 2px solid #DC3545;">
                                <?php
                                    $query = "SELECT * FROM `detailinfo` WHERE code = 'INFOGRAPHIC'";
     ...
     <section style="background:transparent;;position: relative;display: flex;justify-content: center;align-items: center;">
        <div class="row" style="margin-top: 10px;display: flex;justify-content: center;align-items: center;width: 68.5%;">
            ...
            <div id="pagination" style="margin-top: 20px;margin-bottom: 20px;display: flex;justify-content: center;align-items: center;">
   ...
   $(document).ready(function() {
    // Initial load of data
        ...
        $('#infographicForm input, #infographicForm select').on('change', function() {
            // Get form values
            var title = $('#title').val();
            var subject = $('#subject').val();
            var createtime = $('#createtime').val();
            ...
            success: function(data) {
                ...
                data.forEach(function(item) {
                    $('#cards-container').append(`
                        <div class="col-4">
                           <a target="_blank" style="text-decoration: none;color: black" href="infographic-detail.php?id=${item.id}">
                              <div class="card card-custom-infographic" style="height: 520px;">
                                <div class="card-body">
                                    <div class="top">
                                        <img style="width: 100%;height: 400px;" src="infographic/${item.path}" alt="">
                                    </div>                      
                                    <div class="topic">
                                        <p>${item.title}</p>
                                    </div>
                                    <a target="_blank" href="infographic/${item.path}">
