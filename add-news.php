...
<head>
    ...
    <title>เพิ่มข้อมูล<?php echo  $detailthai;?></title>
...
<body style="background-image: url('imanges/18544.jpg');background-position: center;background-size: cover;background-repeat: no-repeat;">
     ...
     <section style="background-image: url('imanges/7666-3.jpg');height: 200px;width: 100%;position: relative;">
        ...
        เพิ่มข้อมูล<?php echo  $detailthai;?>
        </button>
     </section>
     ...
     <section style="margin-bottom: 400px;background:transparent;;position: relative;display: flex;justify-content: center;align-items: center;">
          <div class="row" style="margin-top: 10px;display: flex;justify-content: center;align-items: center;width: 88.5%;">
            <div class="col-12">
                ...
                <div style="width: 100%;" >
                        <h4 style="float: left;">ข้อมูล<?php echo  $detailthai;?></h4>
                        <h4 style="float: right;">
                        <button class="btn btn-primary"   data-bs-toggle="modal" data-bs-target="#multimidiaModal">เพิ่มข้อมูล<?php echo  $detailthai;?></button>
                        </h4>
                    </div>
                </div>
                <br>
                <div class="container mt-4">
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                                <?php
                                include "connect.php";
                                $query = "SELECT * FROM `newsinfo` WHERE subject = '$subject_id'"; // Adjust the query to match your table structure            
                                $result = $con->query($query);
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<tr class='text-white'>
                                                ...
                                                <td class='text-center'>
                                                    <a href='add-news-detail.php?id={$newdetailid}&&subject=$subject_id&&news_id=$mul_id'><button class='btn btn-info'>รายละเอียด</button></a>
                                                    <a href='delete-news.php?id={$mul_id}'><button class='btn btn-danger'>ลบ</button></a>
                                                </td>
                                            </tr>";
                                    }
                                } else {
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div style="width: 100%;" class="card">
                        ...
                        <div class="container mt-4">
                            <div style="width: 100%;" >
                                <h4 style="float: left;">เพิ่มข้อมูล<?php echo  $detailthai;?></h4>    
                            </div>
                        </div>
                        </div>
                        <br>
                        ...
                        <form id="multimidiaaddForm">
                            ...
                            <div class="mb-3">
                            <input id="subject" type="hidden" class="form-control" id="subject" name="subject" value="<?php echo  $subject_id;?>" >
                            </div>                
                            <div style="width: 100%">
    ...
    <script>
        $(document).ready(function() {
            $('#multimidiaaddForm').on('submit', function(event) {
                ...
                $.ajax({
                    url: 'act-add-news.php',  // Replace with your PHP file to handle the request
                    type: 'POST',
                    data: formData,
