            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
             ...
             <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="news.php?subject=2">สำนักข่าวสร้างสุข </a></li>
                  <li><a class="dropdown-item" href="news.php?subject=3">สาระสุขภาพ </a></li>
                  <li><a class="dropdown-item" href="news.php?subject=4">ข่าวสุขภาพ </a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="multimidia.php">มัลธิมิเดีย</a></li>
                  <li><a class="dropdown-item" href="infographic.php">อินโฟกราฟิก </a></li>
                  <li><a class="dropdown-item" href="gallery.php">แกลอรี่</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <ul class="dropdown-menu">
                  <!-- <li><a class="dropdown-item" href="generalannouncement.php">ประกาศทั่วไป</a></li> -->
                  <li><a class="dropdown-item" href="workwithus.php">ร่วมงานกับเรา</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <i class="fas fa-info"></i>&nbsp;รู้จักมูลนิธิคนเห็นคน
                </a>
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="contact.php">ติดต่อสำนักงาน</a></li>
                </ul>
              </li>
            </ul>
