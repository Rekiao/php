...
if (isset($_FILES['video']) && $_FILES['video']['error'] === UPLOAD_ERR_OK) {
    ...
    if (in_array($fileExtension, $allowedExtensions)) {
        ...
        if (move_uploaded_file($fileTmpPath, $destPath)) {
            ...
            $stmt = $con->prepare("INSERT INTO  `multimediainfo` (title,detail,path,createby) VALUES (?,?,?,?)");
            ...
            if ($stmt->execute()) {
                ...
                header("Refresh: 2; URL=add-multimidia.php"); // Redirect to a document list page after 2 seconds
            }
